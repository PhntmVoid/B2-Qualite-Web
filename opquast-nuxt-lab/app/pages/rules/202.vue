        ...
        <div class="p-6">
          ...
          <div v-if="activeTab === 'preview'" class="space-y-4">
            <div class="text-sm text-zinc-400">
              Exemple d'interface de modification de mot de passe personnalisé
            </div>
              ...
              <form class="space-y-4" @submit.prevent>
                ...
                <div class="space-y-1">
                  ...
                  <p class="text-[10px] text-zinc-500">
                    Choisissez un mot de passe facile à mémoriser pour vous.
                  </p>
                </div>
          ...
          <div v-else>
            ...
            >
<code>
&lt;!-- Formulaire permettant le libre choix du mot de passe --&gt;
...
&lt;/section&gt;
            ...
            <p class="mt-3 text-xs text-zinc-500">
              L'implémentation doit permettre à l'utilisateur de saisir
              librement son mot de passe dès la création du compte ou lors d'une
              phase de modification ultérieure.
            </p>
          </div>
        </div>
      </div>
